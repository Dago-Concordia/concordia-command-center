...
class OffCommandFrame(Frame):
    ...
    def initWidget(self):
        self.offButton = Button(self, text="OFF", font = "Helvetica 10 bold", width=10, height=1, command=self.offCommand)
        ...
        self.onAllButton = Button(self, text="ON ALL", font = "Helvetica 10 bold", width=10, height=1, bg='lime green', command=self.onAllCommand)
        self.onAllButton.grid(row=1, column=0, padx=(5, 5), pady=(10, 10))

        self.oaButton = Button(self, text="OA", font = "Helvetica 10 bold", width=10, height=1, command=self.oaCommand)
        self.oaButton.grid(row=1, column=1, padx=(5, 5), pady=(10, 10))
        self.olaButton = Button(self, text="OLA", font = "Helvetica 10 bold", width=10, height=1, command=self.olaCommand)
        self.olaButton.grid(row=1, column=2, padx=(5, 5), pady=(10, 10))
        self.oraButton = Button(self, text="ORA", font = "Helvetica 10 bold", width=10, height=1, command=self.oraCommand)
        self.oraButton.grid(row=1, column=3, padx=(5, 5), pady=(10, 10))
        self.ohButton = Button(self, text="OH", font = "Helvetica 10 bold", width=10, height=1, command=self.ohCommand)
        self.ohButton.grid(row=1, column=4, padx=(5, 5), pady=(10, 10))


        self.ofButton = Button(self, text="OF", font = "Helvetica 10 bold", width=10, height=1, command=self.ofCommand)
        self.ofButton.grid(row=2, column=0, padx=(5, 5), pady=(10, 10))
        self.olfButton = Button(self, text="OLF", font = "Helvetica 10 bold", width=10, height=1, command=self.olfCommand)
        self.olfButton.grid(row=2, column=1, padx=(5, 5), pady=(10, 10))
        self.orfButton = Button(self, text="ORF", font = "Helvetica 10 bold", width=10, height=1, command=self.orfCommand)
        self.orfButton.grid(row=2, column=2, padx=(5, 5), pady=(10, 10))
        self.ohipButton = Button(self, text="OHIP", font = "Helvetica 10 bold", width=10, height=1, command=self.ohipCommand)
        self.ohipButton.grid(row=2, column=3, padx=(5, 5), pady=(10, 10))

        self.offAllButton = Button(self, text="OFF ALL", font = "Helvetica 10 bold", width=10, height=1, bg='red', fg="white", command=self.offAllCommand)
